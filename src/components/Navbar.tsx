            ...
            <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
                    ...
                    <div className="flex items-center gap-3">
                        {isAdmin && (
                            <button
                                ...
                                className="hidden md:block text-sm text-gray-400 hover:text-red-400 transition-smooth px-4 py-2 rounded-lg hover:bg-red-500/10"
                            >
                                Logout
                            </button>
                        )}
                ...
                {isAdmin && mobileOpen && (
                    <div className="md:hidden py-3 border-t border-gray-800/50">
                        <Link href="/admin/dashboard" className="block px-4 py-2.5 text-sm text-gray-300 hover:bg-gray-800/50 rounded-lg">
                            Dashboard
                        </Link>
                        <Link href="/admin/tests/create" className="block px-4 py-2.5 text-sm text-gray-300 hover:bg-gray-800/50 rounded-lg">
                            Create Test
                        </Link>
